       ...
       ****************/
        ...
        function fileSizeLimit(element) {
            ...
            element.forEach((item) => {
                item.addEventListener('change', () => {
                    ...
                    if (fileSize > maxSize) {
                        alert('The size of the image is above 8mb, please reduce the size');
                        item.value = '';
                        fileName = '';
        ...
        ****************/
        ...
        $('#registration-form').submit(function (event) {
            ...
            $.ajax({
                url: 'https://adminicfs.agro.uz/api/data',
                type: 'POST',
                dataType: 'json',
                data: formData,
                processData: false,
                ...
                success: function (response) {
                    ...
                    photo_text.textContent = 'load';
                    passport_text.textContent = 'load';
